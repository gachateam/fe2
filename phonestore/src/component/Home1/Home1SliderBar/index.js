            ...
            <CustomSlick settings={settings}>
                <div className="product-list-content">
                    ...
                    <div className="single-product-list mb-3">
                        <div className="product-list-image">
                            <Link to="/product-details" tabIndex="-1">
                                <img src="./img/feature/feature-2.jpg" alt="hinh1" className="img-fluid block-one" />{/**/}
                                <img src="./img/feature/feature-5.jpg" alt="hinh2" className="img-fluid block-two" />{/**/}
                            </Link>
                        </div>
                        <div className="product-caption">
                            <div className="product-name">
                    ...
                    <div className="single-product-list">
                        <div className="product-list-image">
                            <Link to="/product-details" tabIndex="-1">
                                <img src="./img/feature/feature-3.jpg" alt="hinh1" className="img-fluid block-one" />
                                <img src="./img/feature/feature-4.jpg" alt="hinh2" className="img-fluid block-two" />
                            </Link>
                        </div>
                        <div className="product-caption">
                            <div className="product-name">
